...
try {
    ...
    //Cria a Query SQL
    $query = "SELECT membros.nome, membros.escola, membros.funcao, membros.numero_equipe, membros.email, escolas.nome_escola, escolas.cidade, escolas.estado, equipes.nome_equipe, equipes.numero_equipe from membros, equipes, escolas where membros.numero_equipe = equipes.numero_equipe and membros.escola = escolas.nome_escola";
    //Executa a Query
...
?>
        ...
        <td width="10">&nbsp;</td>
        <td><strong>Numero Equipe</strong></td>
        <td width="10">&nbsp;</td>
